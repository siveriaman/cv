...
\label{sec-1-4}
\textbf{Programming language:} PHP, Mysql, Javascript, Bash, Python, Java, HTML\\
\label{sec-1-5}
...
\label{sec-1-11}
\textbf{CI and Build tools:} Jenkins, Gitlab Runner, CloudBuild, Gradle, Maven\\
\label{sec-1-12}

...
Full development lifecycle support including requirements clarification and management, development, deployment and support of Web and E-commerce solutions based on PHP, Java, Node.js and Python. Database configuration and support using Mysql, MariaDB, PostgreSQL. etc.\\
...
\label{sec-1-11}
\textbf{CI and Build tools:} Jenkins, TeamCity, Gitlab Runner, CloudBuild, Gradle, Maven\\
\label{sec-1-12}
\textbf{CCA tools:} Terraform, Ansible\\
\label{sec-1-13}
\textbf{Containers and microservices orchestration:} Docker, Kubernetes, Helm, Docker Compose\\
\label{sec-1-14}
\textbf{VCS and tools:} Github, Bitbucket, Gitlab, SVN\\
\label{sec-1-15}
\textbf{Other skills:}  Node.js, iptables, LDAP, Bind, Nexus, Sonar, npm, Zabbix, Nagios\\
\section{Work experience}
\label{sec-2}
\subsection{{January 2022 – Present}. DevOps Engineer, Intellias}
\label{sec-2-1}
\subsubsection{}
\label{sec-2-1-1}
\textbf{Project:} provisioning and automation of infrastructure\\
\textbf{Project Role:}  Deployment Engineer\\
\textbf{Responsibilities:}\\
\begin{itemize}
\item Creating and provisioning of microservice application based on Kustomize structure to Google Kubernetes Engine
\item Creation and update infrastructure and services using Terraform and Gitlab pipeline
\item Dev/Test/Demo/Prod environments implementation
\item Creating CI/CD process using Gitlab pipelines for Javascript project
\item Resolving tasks and support developing team using GitLab Issues and Jira
\item SSL Certificates implementation for microservices using cert-manager.
\end{itemize}
\textbf{Languages:} Bash, SQL\\
\textbf{Tools:} Kubernetes(GKE), Terraform, Docker, Nginx, Jira, Gcloud SDK \\ 
\textbf{Databases:} Postgres, MySQL, Redis\\
\textbf{Source control tools:} Gitlab\\
\textbf{OS:} Debian, CentOS, Ubuntu \\

\subsection{{August 2018 – December 2021}. DevOps Engineer, Epam Systems}
\label{sec-2-1}
\subsubsection{}
\label{sec-2-1-1}
